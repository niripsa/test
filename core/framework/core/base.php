...
final class Base{
	...
	public static function init() {
	    ...
	    //经过这里,$settting_config就有$config中的内容
	...
	private static function parse_conf(&$setting_config){
		...
		//$setting['hao_version'] = 'Copyright 2015 <a href="http://www.haoid.cn" target="_blank">www.haoid.cn</a> All rights reserved.<br />本演示来源于<a href="http://www.haoid.cn" target="_blank">www.haoid.cn</a>';
	...
	private static function control(){
		...
		//$act_file="D:\Code\SHOPNC\shopnc\shop\control\xxxxx.php"
	...
	private static function start_session(){
		...
		//$subdomain_suffix="127.0.0.1"(子域名后缀？)
