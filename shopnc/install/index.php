...
$html_title = 'haoid.cn 好商城V4电商系统 安装程序';

//<<<EOF 内容  EOF 用于输出大段非php内容，其中可以任意换行，特殊符号也不用转义
$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>haoid.cn 好商城V4电商系统 安装程序</h5>
      <h2>系统安装向导</h2>
    </div>
    <div class="version">版本: 2016.01.13</div>
  </div>
</div>
...
$html_footer = <<<EOF
<div class="footer">
  <h6><a href="http://www.haoid.cn" target="_blank">程序来源于 好商城 haoid.cn</a></h6>
</div>
EOF;
...
function step3(&$install_error,&$install_recover){
    ...
    if ($_POST['demo_data'] == '1'){
        $db->query("UPDATE {$db_prefix}store SET `live_store_name`='好商城V4',`live_store_address`='中国',`live_store_tel`='400-80000000',`live_store_bus`='33路' WHERE `store_id`=1");
